...
resource "azurerm_cosmosdb_sql_database" "tickets" {
  name                = "TicketDB"
  resource_group_name = data.azurerm_resource_group.main_resource_group.name
  account_name        = data.azurerm_cosmosdb_account.ticket_db_account.name
}
...
resource "azurerm_role_assignment" "cosmos_identity_role" {
  scope                = data.azurerm_cosmosdb_account.ticket_db_account.id
...
data "azurerm_cosmosdb_sql_role_definition" "cosmos_db_built_in_data_contributor" {
  resource_group_name = data.azurerm_cosmosdb_account.ticket_db_account.resource_group_name
  account_name        = data.azurerm_cosmosdb_account.ticket_db_account.name
